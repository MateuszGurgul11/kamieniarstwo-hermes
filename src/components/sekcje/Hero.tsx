        ...
        <div className="grid gap-12 lg:grid-cols-[1.15fr_0.85fr] lg:items-end lg:gap-14">
          <div>
            ...
            <p className="mt-7 max-w-xl text-lg leading-relaxed text-szron/75">
              Pracownia {firma.wlasciciel === "Bogusław Krzyśko" ? "Bogusława Krzyśki" : firma.wlasciciel}.
              Tniemy kamień, budujemy i stawiamy nagrobki, a przy pogrzebie
              rozbieramy je i składamy z powrotem. Większość prac wykonujemy
              własnoręcznie — dlatego pomnik może powstać niemal według każdego
              projektu.
            </p>
