      ...
      <div className="mx-auto max-w-6xl px-5 py-12 sm:px-8">
        <div className="flex flex-wrap items-start justify-between gap-8">
          <div>
            ...
            <p className="mt-2 max-w-xs text-lg leading-relaxed text-grafit/60">
            ...
            <ul className="grid grid-cols-2 gap-x-10 gap-y-2.5">
              {nawigacja.map((pozycja) => (
                <li key={pozycja.href}>
                  <a
                    href={pozycja.href}
                    className="text-lg text-grafit/65 transition-colors hover:text-mosiadz"
                  >
                    {pozycja.etykieta}
                  </a>
                </li>
        ...
        <p className="rzaz mt-10 pt-5 font-utyl text-lg text-grafit/40">
